...
to_show_sf <- sf::st_as_sf(to_show)
tm_shape(to_show_sf) + tm_polygons(col = 'resid')
```
...
## Archive in GitHub:
https://github.com/YDSrun/GWPR.light.new
## BugReports: 
If you find bugs or have other ideas, be free to contact us.
https://github.com/YDSrun/GWPR.light.new/issues
